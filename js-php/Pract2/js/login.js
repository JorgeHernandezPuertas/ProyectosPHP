...
{
    $('#errores').html("");
    var html_principal="<div id='saludo'>Bienvenido <strong>"+datos_usu_log["usuario"]+"</strong> - <button onclick='cerrar_sesion();' class='enlace'>Salir</button></div>";
    html_principal+="<div id='respuestas'></div><div id='productos'></div>";
